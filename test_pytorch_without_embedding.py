...
try:
        data = rename_columns_based_on_content(csv_file_path )
        print(data.head())
...
# model_name = "/home/safikhani/main_repository/Auto-PyTorch_autoNLP/Fine-tuned-models/final_occupation_coding"
